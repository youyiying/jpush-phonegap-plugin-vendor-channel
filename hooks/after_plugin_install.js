...
var REPOSITORIES_GRADLE_CORDOVALIB =
...
module.exports = function () {
  ...
  if (!FSUtils.exists(PUSH_CONFIG_FILE)) {
    console.log(
      "push_config file does not exist. after_plugin_install script wont be executed."
    );
    return;
  }
  pushConfig = JSON.parse(FSUtils.readFile(PUSH_CONFIG_FILE, "UTF-8"));
  var rootGradleContent = FSUtils.readFile(
    ROOT_GRADLE_FILE,
    "UTF-8"
  ).toString();
    ...
    for (var i = 0; i < lines.length; i++) {
      ...
      if (line.indexOf("defaultConfig {") >= 0) {
        lines[i] =
          ...
          "',\n" +
          "                JPUSH_APPKEY  : '" +
          pushConfig.JPUSH_APPKEY +
          "',\n" +
          "                JPUSH_CHANNEL : '" +
          pushConfig.JPUSH_CHANNEL +
          "',\n" +
          "                MEIZU_APPID  : '" +
          pushConfig.MEIZU_APPID +
          "',\n" +
          "                MEIZU_APPKEY  : '" +
          pushConfig.MEIZU_APPKEY +
          "',\n" +
          "                XIAOMI_APPID  : '" +
          pushConfig.XIAOMI_APPID +
          "',\n" +
          "                XIAOMI_APPKEY : '" +
          pushConfig.XIAOMI_APPKEY +
          "',\n" +
          "                OPPO_APPKEY   : '" +
          pushConfig.OPPO_APPKEY +
          "',\n" +
          "                OPPO_APPID    : '" +
          pushConfig.OPPO_APPID +
          "',\n" +
          "                OPPO_APPSECRET: '" +
          pushConfig.OPPO_APPSECRET +
          "',\n" +
          "                VIVO_APPKEY   : '" +
          pushConfig.VIVO_APPKEY +
          "',\n" +
          "                VIVO_APPID    : '" +
